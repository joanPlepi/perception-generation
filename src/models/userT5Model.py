...
class T5ForConditionalGenerationUserExtended(T5PreTrainedModel):
    ...
    def forward(
        ...
        if self.mode[0] == 'decoder_comments':
            ...
            extra_encoder_outputs = self.encoder(
                input_ids=history_comments_inputs,
                attention_mask=history_comments_attention_mask,
                inputs_embeds=None,
                head_mask=None,
            ...
            extra_attention_mask = history_comments_attention_mask
        elif self.mode[0] == 'decoder_persona':
            # Convert encoder inputs in embeddings if needed
            extra_encoder_outputs = self.encoder(
            ...
            extra_attention_mask = persona_attention_mask
        else:
        ...
        extra_decoder_outputs = self.extra_decoder(
            ...
            attention_mask=decoder_attention_mask,
            inputs_embeds=decoder_inputs_embeds,
            past_key_values=comments_past_key_values,
        ...
        return Seq2SeqLMOutputExtended(
            ...
            comments_past_key_values = extra_decoder_outputs.past_key_values, # extra
